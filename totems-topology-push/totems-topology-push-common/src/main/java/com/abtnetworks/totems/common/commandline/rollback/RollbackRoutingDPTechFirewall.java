...
import com.abtnetworks.totems.common.commandline.routing.RoutingDPTechFirewall;
import com.abtnetworks.totems.common.dto.CmdDTO;
import com.abtnetworks.totems.common.dto.commandline.RoutingCommandDTO;
import org.springframework.stereotype.Service;

@Service
public class RollbackRoutingDPTechFirewall implements PolicyGenerator {
    @Override
    public String generate(CmdDTO cmdDTO) {
        RoutingDPTechFirewall generator = new RoutingDPTechFirewall();
