...
@Slf4j
@Service
public class RollbackSnatUsg6000 implements PolicyGenerator {

    protected OverAllGeneratorAbstractBean generatorBean;

    public RollbackSnatUsg6000() {
    ...
    public PolicyGeneratorDTO generateV2(CmdDTO cmdDTO) {
        ...
        try {
            ...
            if(CollectionUtils.isEmpty(addressNames) && CollectionUtils.isEmpty(serviceNames) && CollectionUtils.isEmpty(addressGroupNames)){
