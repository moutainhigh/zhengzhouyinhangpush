...
@Service
@Slf4j
public class AtomSecurityAbtBList extends SecurityPolicyGenerator implements PolicyGenerator {

    private SecurityAbtBListImpl generatorBean;

    public AtomSecurityAbtBList() {
        generatorBean = new SecurityAbtBListImpl();
    }
    ...
    private String createCommandLine(CommandlineDTO dto) {
        log.info("生成abnetworks blist设备命令行开始，入参为：\n{} ", JSONObject.toJSONString(dto));
        ...
        log.info("生成abtnetworks blist命令行结束：\n {}", securityCl);
        return sb.toString();
    }
    ...
    public static void main(String[] args) {
        ...
        AtomSecurityAbtBList abtcomandEntity = new AtomSecurityAbtBList();
