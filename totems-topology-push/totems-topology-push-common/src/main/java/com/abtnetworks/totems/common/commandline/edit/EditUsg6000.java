...
@Service
public class EditUsg6000 extends EditPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(EditUsg6000.class);
    ...
    public String createCommandLine(EditCommandlineDTO dto){
        ...
        return  securityUsg6000.generatePreCommandline(dto1)+securityUsg6000.createMergeCommandLine(dto1,dto.getMergeProperty());
    }
