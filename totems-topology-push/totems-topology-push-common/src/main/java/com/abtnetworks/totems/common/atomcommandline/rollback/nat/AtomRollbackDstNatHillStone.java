...
@Service
@Log4j2
public class AtomRollbackDstNatHillStone extends BaseHillStoneCommonBuss implements PolicyGenerator {

    private NatHillStoneR5Impl generatorBean;

    public AtomRollbackDstNatHillStone() {
    ...
    public String generate(CmdDTO cmdDTO) {
        ...
        sb.append(generatorBean.deleteNatPolicyByIdOrName(NatTypeEnum.DST,PLACE_HOLDER,generatedObjectDTO.getPolicyName(),map,null));
