...
/**
 * @author lifei
 * @desc 天融信bothNat 回滚命令行执行器
 * @date 2021/10/19 10:45
 */
@Slf4j
@Service
public class RollbackBothTopsecTos010020 extends BaseTopsecCommonBuss implements PolicyGenerator {

    private OverAllGeneratorAbstractBean generatorBean;

    public RollbackBothTopsecTos010020() {
        generatorBean = new SecurityTopsec010Impl();
    }

    @Override
    public String generate(CmdDTO cmdDTO) {
        log.info("天融信bothnat 开始回滚---");
