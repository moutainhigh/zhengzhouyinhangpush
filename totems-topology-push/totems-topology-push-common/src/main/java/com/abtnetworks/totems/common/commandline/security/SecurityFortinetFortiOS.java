...
@Service
public class SecurityFortinetFortiOS extends SecurityPolicyGenerator implements PolicyGenerator {
    ...
    public String generate(CmdDTO cmdDTO) {
        ...
        generatedDto.setPolicyName(dto.getBusinessName());
        return commandLine;
    }
...
//            sb.append( createAddressObject(dstAddresses,dstAddressName));
        ...
        sb.append(createPolicy(theme,String.valueOf(dto.getCurrentId()), srcItfList, dstItfList, srcAddressNameList,
                ...
                dto.getIp(), dto.getSrcZone(), dto.getAction(),dto));
        if (dto.isVsys()) {
            sb.append("end\n");
        }
        return sb.toString();
    ...
    private String createServiceObject(ServiceDTO service, List<String> serviceNameList,List<String> createServiceNameList) {
        ...
        for (String port : dstPortList) {
            ...
            createServiceNameList.add(serviceName);
            sb.append("next\n");
            sb.append("end\n\n");
        }
        return sb.toString();
    ...
    String createPolicy(String theme,String policyName, List<String> srcItfList, List<String> dstItfList,
                        ...
                        String srcZone, String action,CommandlineDTO dto) {
        StringBuilder sb = new StringBuilder();
        sb.append(String.format("edit %s\n", "0"));
        String newPolicyName = String.format("%s_AO_%s\n",theme, IdGen.getRandomNumberString());
        sb.append("set name ").append(newPolicyName);
        ...
        dto.setBusinessName(newPolicyName);
...
//            }
    ...
    public static void main(String[] args) {
        ...
        String commandLine = fortinet.createCommandLine(dto);
