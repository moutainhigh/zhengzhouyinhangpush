...
@Slf4j
@Service
public class FortinetNatV5 implements NatPolicyGenerator {
...
//        sb.append("set name ").append(policyName).append(StringUtils.LF);
        ...
        sb.append("set comment ").append(policyName).append(StringUtils.LF);
        sb.append("show\n");
        sb.append("next\n");
...
//        sb.append("set name ").append(policyName).append(StringUtils.LF);
    ...
    private String buildServiceCommandLine(StringBuilder sb, String protocol, String dstPorts, String serviceName, Boolean isExist, List<String> createServiceObjectName) {
        if (StringUtils.isNotEmpty(protocol) && isExist == false) {
            ...
            if (StringUtils.isNotBlank(serviceName) && !serviceName.equalsIgnoreCase("ANY") && !serviceName.equalsIgnoreCase("ALL_ICMP")) {
