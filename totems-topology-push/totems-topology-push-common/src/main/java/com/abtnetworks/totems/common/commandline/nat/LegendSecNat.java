...
import com.abtnetworks.totems.common.commandline.security.SecurityLegendSec;
 ...
 */
@Slf4j
@Service(value = "LegendSecNSGNAT")
public class LegendSecNat implements NatPolicyGenerator {
    ...
    public String generateStaticNatCommandLine(StaticNatTaskDTO policyDTO) {
        ...
        //调用安全策略的处理对象的方法
        SecurityLegendSec securityLegendSec = new SecurityLegendSec();
        PolicyObjectDTO srcAddressObject = securityLegendSec.generateAddressObject(policyDTO.getInsideAddress(), policyDTO.getTheme(), policyDTO.isCreateObject(), policyDTO.getInsideAddressName(), "inside");
        PolicyObjectDTO dstAddressObject = securityLegendSec.generateAddressObject(policyDTO.getGlobalAddress(), policyDTO.getTheme(), policyDTO.isCreateObject(), policyDTO.getGlobalAddressName(), "global");
        ...
        PolicyObjectDTO policyObjectDTO = securityLegendSec.generateServiceObject(serviceDTOList, true, false, null);
        ...
        if (isAnyPostObject) {
            ...
            sb.append("sip ").append(srcAddressObject.getJoin())
                    .append(" dip ").append(CommonConstants.ANY).append(" egress-interface ").append(outDevItf)
        ...
        sb.append("snat ").append(policyDTO.getTheme()).append(" top\n");
    ...
    public String generateSNatCommandLine(SNatPolicyDTO policyDTO) {
        SecurityLegendSec securityLegendSec = new SecurityLegendSec();
        PolicyObjectDTO srcAddressObject = securityLegendSec.generateAddressObject(policyDTO.getSrcIp(), policyDTO.getTheme(), policyDTO.isCreateObjFlag(), policyDTO.getSrcAddressObjectName(), "src");
        PolicyObjectDTO dstAddressObject = securityLegendSec.generateAddressObject(policyDTO.getDstIp(), policyDTO.getTheme(), policyDTO.isCreateObjFlag(), policyDTO.getDstAddressObjectName(), "dst");
        PolicyObjectDTO policyObjectDTO = securityLegendSec.generateServiceObject(policyDTO.getRestServiceList(), policyDTO.isCreateObjFlag(), false, policyDTO.getExistServiceNameList());
        PolicyObjectDTO postSrcAddressObject = securityLegendSec.generateAddressObject(policyDTO.getPostIpAddress(), policyDTO.getTheme(), policyDTO.isCreateObjFlag(), policyDTO.getPostAddressObjectName(), "post");
        StringBuffer sb = new StringBuffer();
        preCommand(sb, policyDTO.isVsys(), policyDTO.getVsysName());
        if (srcAddressObject.isObjectFlag() && !AliStringUtils.isEmpty(srcAddressObject.getCommandLine())) {
            sb.append(srcAddressObject.getCommandLine());
        ...
        if (isAllAny) {
            ...
            sb.append(dstAddressObject.getJoin()).append(" egress-interface ")
                    .append(dstItfJoin);
    ...
    public String generateDNatCommandLine(DNatPolicyDTO policyDTO) {
        ...
        PolicyObjectDTO dstAddressObject = securityLegendSec.generateAddressObject(policyDTO.getDstIp(), policyDTO.getTheme(), policyDTO.isCreateObjFlag(), policyDTO.getDstAddressObjectName(), "dst");
        PolicyObjectDTO policyObjectDTO = securityLegendSec.generateServiceObject(policyDTO.getRestServiceList(), policyDTO.isCreateObjFlag(), false, policyDTO.getExistServiceNameList());
        PolicyObjectDTO postAddressObject = securityLegendSec.generateAddressObject(policyDTO.getPostIpAddress(), policyDTO.getTheme(), false, policyDTO.getPostAddressObjectName(), "post");
        ...
        sb.append("object network server ").append(postAddressObject.getJoin()).append(CommonConstants.LINE_BREAK);
        ...
        sb.append("dnat ").append(policyDTO.getTheme()).append(" top\n");
        policyDTO.setPolicyName(policyDTO.getTheme());
        sb.append("end\n");
        sb.append("save config\n");
        return sb.toString();
