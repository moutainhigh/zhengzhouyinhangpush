 ...
 */
@Service
public class EditH3cSecPathV5 extends EditPolicyGenerator implements PolicyGenerator {

    Logger logger = LoggerFactory.getLogger(EditH3cSecPathV5.class);


    @Override
    public String generateCommandline(EditCommandlineDTO dto) {
        logger.info("EditH3cSecPathV5.generateCommandline...");
        return EditH3cSecPathCommon.generateCommandline(dto,new SecurityH3cSecPathV5Impl());
    }
