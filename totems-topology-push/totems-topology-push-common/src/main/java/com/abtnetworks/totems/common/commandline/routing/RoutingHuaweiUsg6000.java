...
@Slf4j
@Service
public class RoutingHuaweiUsg6000 implements RoutingGenerator , PolicyGenerator {
    ...
    /**
     * ip route-static 1.1.1.0 24 NULL 0
     * ipv6 route-static ff:a::2:d 128 NULL 0
     * @param dto
     * @return
     */
    @Override
    public String generatorRoutingCommandLine(RoutingCommandDTO dto) throws UnknownHostException {
        ...
        if (dto.getRoutingType().equals(RoutingCommandDTO.RoutingType.UNREACHABLE)) {
            ...
            allIpList.forEach(ip -> {
                if (ip.contains(":")) {
                    //ipv6
                    stringBuilder.append("ipv6 route-static ").append(ip).append(" 128 NULL 0\n");
                } else {
                    //ipv4
                    stringBuilder.append("ip route-static ").append(ip).append(" 32 NULL 0\n");
                }
            });
        }
    ...
    /**
     * undo ip route-static 1.1.1.0 24 NULL 0
     * undo ipv6 route-static ff:a::2:d 128 NULL 0
     * @param dto
     * @return
     */
    @Override
    public String deleteRoutingCommandLine(RoutingCommandDTO dto) throws UnknownHostException {
        ...
        if (dto.getRoutingType().equals(RoutingCommandDTO.RoutingType.UNREACHABLE)) {
            ...
            allIpList.forEach(ip -> {
                if (ip.contains(":")) {
                    //ipv6
                    stringBuilder.append("undo ipv6 route-static ").append(ip).append(" 128 NULL 0\n");
                } else {
                    //ipv4
                    stringBuilder.append("undo ip route-static ").append(ip).append(" 32 NULL 0\n");
                }
            });
        }
        stringBuilder.append(generatePostCommandLine(dto));
