...
@Service
public class EditJuniperSrxNoCli extends EditPolicyGenerator implements PolicyGenerator {
    ...
    public String createCommandLine(EditCommandlineDTO dto) {
        ...
        sb.append("configure\n");
        //创建地址对象
        sb.append(createAddressCommandline(name, srcZone, restSrcAddressList, existSrcAddressList));
        sb.append(createAddressCommandline(name, dstZone, restDstAddressList, existDstAddressList));
        //创建服务对象
    ...
    public String createAddressCommandline(String name, String srcZone, List<String> restSrcAddressList, List<String> existSrcAddressList) {
        //创建新增IP,并加入复用列表
        //多个ip建地址组
        StringBuilder sb = new StringBuilder();
