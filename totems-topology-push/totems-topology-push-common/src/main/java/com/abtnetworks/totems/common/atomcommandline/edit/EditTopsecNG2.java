 ...
 */
@Service
public class EditTopsecNG2 extends EditPolicyGenerator implements PolicyGenerator {
    Logger logger = LoggerFactory.getLogger(EditTopsecNG2.class);


    @Override
    public String generateCommandline(EditCommandlineDTO dto) {
        logger.info("EditTopsec010.generateCommandline...");
        return EditTopsecCommon.generateCommandline(dto,new SecurityTopsecNG2Impl());
    }
