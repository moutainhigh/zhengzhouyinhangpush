...
/**
 * @author lifei
 * @desc 飞塔V5.2型号设备安全策略命令行
 * @date 2022/2/22 15:48
 */
@Service
@Log4j2
public class AtomSecurityFortinetV5 extends SecurityPolicyGenerator implements PolicyGenerator {
    private SecurityFortinet310BImpl generatorBean;

    public AtomSecurityFortinetV5() {
        generatorBean = new SecurityFortinet310BImpl();
    }
    ...
    public String generate(CmdDTO cmdDTO) {
        ...
        log.info("飞塔V5.2设备原子化命令行dto:{}", JSONObject.toJSONString(dto));
