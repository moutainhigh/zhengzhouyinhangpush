...
/**
 * @author lifei
 * @desc 天融信回滚snat命令行执行器
 * @date 2021/10/19 10:14
 */
@Slf4j
@Service
public class RollbackSnatTopsecTos010020 extends BaseTopsecCommonBuss implements PolicyGenerator {

    private OverAllGeneratorAbstractBean generatorBean;

    public RollbackSnatTopsecTos010020() {
        generatorBean = new SecurityTopsec010Impl();
    }

    @Override
    public String generate(CmdDTO cmdDTO) {
        log.info("天融信snat 开始回滚---");
