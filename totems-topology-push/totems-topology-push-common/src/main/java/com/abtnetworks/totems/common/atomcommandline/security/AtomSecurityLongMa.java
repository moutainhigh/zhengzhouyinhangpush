...
@Service
@Slf4j
public class AtomSecurityLongMa extends SecurityPolicyGenerator implements PolicyGenerator {

    private SecurityLongMaImpl generatorBean;

    public AtomSecurityLongMa() {
        generatorBean = new SecurityLongMaImpl();
    }
    ...
    private String createCommandLine(CommandlineDTO dto) {
        ...
        try {
            ...
            }else if(dto.getIpType()==0){
                type = StatusTypeEnum.ADD_IPV4;
            }else if(dto.getIpType()==1){
                type = StatusTypeEnum.ADD_IPV6;
            }
    ...
    public static void main(String[] args) {
        ...
        AtomSecurityLongMa abtcomandEntity = new AtomSecurityLongMa();
