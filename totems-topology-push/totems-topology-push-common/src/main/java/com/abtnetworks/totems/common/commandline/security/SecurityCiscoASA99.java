...
@Slf4j
@Service
public class SecurityCiscoASA99 extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = LoggerFactory.getLogger(SecurityCiscoASA99.class);
...
//            dto.setObjectFlag(false);
        ...
        dto.setCreateObjectName(createAddressNames);
        dto.setCreateGroupObjectName(createAddressGroupNames);
        return dto;
    }
    ...
    public PolicyObjectDTO generateServiceObject(List<ServiceDTO> serviceDTOList, boolean createObjFlag, RefObjectDTO refObjectDTO ,int iptype) {
        ...
        List<String> createServiceGroupNames = new ArrayList<>();
        ...
        createServiceGroupNames.add(name);
        ...
        dto.setCommandLine(sb.toString());
        dto.setObjectFlag(true);
        dto.setCreateServiceGroupObjectNames(createServiceGroupNames);
        return dto;
