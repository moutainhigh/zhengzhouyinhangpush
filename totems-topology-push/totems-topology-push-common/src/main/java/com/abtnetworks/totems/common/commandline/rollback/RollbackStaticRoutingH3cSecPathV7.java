...
@Service
public class RollbackStaticRoutingH3cSecPathV7 implements PolicyGenerator {

    private StaticRoutingH3cSecPathV7Impl secPathV7;

    public RollbackStaticRoutingH3cSecPathV7() {
    ...
    public String generate(CmdDTO cmdDTO) {
        ...
        try {
            ...
            if (IpTypeEnum.IPV4.getCode() == policy.getIpType().intValue()){
                sb.append(secPathV7.deleteIpv4RoutingCommandLine(policy.getDstIp(),routingInfoDTO.getSubnetMask(),
                        routingInfoDTO.getNextHop(),routingInfoDTO.getOutInterface(),routingInfoDTO.getPriority(),null, policy.getDescription(),map,null));
            }else {
                sb.append(secPathV7.deleteIpv6RoutingCommandLine(policy.getDstIp(),routingInfoDTO.getSubnetMask(),
                        routingInfoDTO.getNextHop(),routingInfoDTO.getOutInterface(),routingInfoDTO.getPriority(),null, policy.getDescription(),map,null));
            }
