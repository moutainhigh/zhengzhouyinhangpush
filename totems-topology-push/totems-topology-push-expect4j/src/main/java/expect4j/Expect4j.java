...
public class Expect4j {
     ...
     * @param is the <code>InputStream</code> to use for reading data
     * @param os the <code>OutputStream</code> to use for writing data
     * @param isCharsetName is 字符集
     * @param osCharsetName os 字符集
     * @throws UnsupportedEncodingException
     */
    public Expect4j(InputStream is, OutputStream os, String isCharsetName, String osCharsetName) throws UnsupportedEncodingException {
        this( new StreamPair(is, os, isCharsetName, osCharsetName) );
        logger.trace("Created Expect4J instance " + this + " based on InputStream " + is + " and OutputStream " + os);
    }
