...
@Service
public class SecurityTopsecTos010020AHNX extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityTopsecTos010020AHNX.class);
...
//        ipv4
    ...
    public static void main(String[] args) {
        ...
        SecurityTopsecTos010020AHNX topsec = new SecurityTopsecTos010020AHNX();
        dto.setIpType(1);
