...
public class SecurityFortinetFortiOSForZSZQ extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityFortinetFortiOSForZSZQ.class);
...
//        dto.setBusinessName(policyName);
        sb.append(createPolicy(theme, srcItfList, dstItfList, srcAddressNameList,
