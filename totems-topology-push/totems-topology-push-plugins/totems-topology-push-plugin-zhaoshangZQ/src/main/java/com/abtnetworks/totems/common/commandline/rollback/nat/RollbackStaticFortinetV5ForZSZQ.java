...
import com.abtnetworks.totems.common.commandline.rollback.RollbackStaticFortinet;
...
@Service
@Log4j2
@CustomCli(value = DeviceModelNumberEnum.FORTINET_V5, type = PolicyEnum.STATIC, classPoxy = RollbackStaticFortinet.class)
public class RollbackStaticFortinetV5ForZSZQ implements PolicyGenerator {

    private OverAllGeneratorAbstractBean generatorBean;


    public RollbackStaticFortinetV5ForZSZQ(){
        generatorBean = new NatFortinetForIosImpl();
    }

    @Override
    public String generate(CmdDTO cmdDTO) {
        log.info("开始进入飞塔5.0设备 Static-nat回滚插件...");
