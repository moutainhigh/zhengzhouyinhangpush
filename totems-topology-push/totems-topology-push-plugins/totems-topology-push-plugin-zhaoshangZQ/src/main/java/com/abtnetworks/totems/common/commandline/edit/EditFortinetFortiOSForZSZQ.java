...
public class EditFortinetFortiOSForZSZQ extends EditPolicyGenerator implements PolicyGenerator {
    ...
    public String createCommandLine(EditCommandlineDTO dto) {
        SecurityFortinetFortiOSForZSZQ securityFortinetFortiOS = new SecurityFortinetFortiOSForZSZQ();
