...
import com.abtnetworks.totems.common.commandline.security.SecurityHillStoneR5ForHunanDL;
...
public class EditHillStoneForHunanDL extends EditPolicyGenerator implements PolicyGenerator {
    ...
    public String createCommandLine(EditCommandlineDTO dto) {
        SecurityHillStoneR5ForHunanDL securityHillStoneR5 = new SecurityHillStoneR5ForHunanDL();
