...
public class SecurityUsg6000ForhuaXia extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityUsg6000ForhuaXia.class);
    ...
    public PolicyObjectDTO generateAddressObject(String ipAddress, String ticket, String ipPrefix, boolean createObjFlag, String existsAddressName, String ipSystem,
        ...
        if (!createObjFlag) {
            ...
            dto.setJoin(ipPrefix + " " + dto.getName() + " \n");
        } else {
            //直接显示内容
            StringBuilder sb = new StringBuilder();
            for (String address : arr) {
...
//                    }
    ...
    public static void main(String[] args) {
        SecurityUsg6000ForhuaXia usg6000 = new SecurityUsg6000ForhuaXia();
        CommandlineDTO dto = CommandlineDTO.getInstanceDemo();

        dto.setIpType(0);
        dto.setSrcIp("3.5.2.5-3.1.4.1,3.5.2.64");

        dto.setDstIp("5.2.5.2");
        List<ServiceDTO> serviceDTOS = new ArrayList<>();
        ServiceDTO serviceDTO = new ServiceDTO();
        serviceDTO.setProtocol("6");
        serviceDTO.setDstPorts("20,23");
