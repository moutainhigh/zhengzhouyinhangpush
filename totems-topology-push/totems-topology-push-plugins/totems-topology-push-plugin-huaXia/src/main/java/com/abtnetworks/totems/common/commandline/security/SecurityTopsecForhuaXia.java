...
public class SecurityTopsecForhuaXia extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityTopsecForhuaXia.class);
    ...
    public PolicyObjectDTO generateTimeObject(String startTime, String endTime, String ticket) {
        ...
        sb.append(String.format("schedule add name %s cyctype yearcyc year-start-date %s year-start-time %s " +
                        " year-end-date %s year-end-time %s\n", name, getDate(startTime), getTime(startTime),
    ...
    public static void main(String[] args) {
        ...
        SecurityTopsecForhuaXia topsec = new SecurityTopsecForhuaXia();
        ...
        dto.setSrcIp("2.4.3.1-10.32.4.2");
        dto.setDstIp("4.6.2.6/24");
