...
public class SecurityHillStoneStoneOSForShenZhen extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityHillStoneStoneOSForShenZhen.class);
    ...
    public SecurityHillStoneStoneOSForShenZhen() {
        init();
    }
    ...
    public PolicyObjectDTO generateAddressObject(String ipAddress, String ticket, String ipPrefix, boolean createObjFlag, String existsAddressName, String ipSystem, Integer ipType) {
        ...
        for (String address : arr) {
            // 是创建对象
            if (createObjFlag) {
                formatFullAddress(address, sb, ipPrefix, createObjFlag, dto, ipSystem, ipType);
                sb.append("exit\n");
    ...
    private void formatFullAddress(String address, StringBuilder sb, String ipPrefix, boolean createObjFlag, PolicyObjectDTO dto, String ipSystem, Integer ipType) {
        ...
        if (ipType.intValue() == IpTypeEnum.IPV4.getCode()) {
            if (IpUtils.isIPSegment(address)) {
                ...
                name = String.format("%s_%s", startIp, endIpArr[endIpArr.length-1]);
            } else {
    ...
    public static void main(String[] args) {
        ...
        SecurityHillStoneStoneOSForShenZhen hillStoneR5 = new SecurityHillStoneStoneOSForShenZhen();
