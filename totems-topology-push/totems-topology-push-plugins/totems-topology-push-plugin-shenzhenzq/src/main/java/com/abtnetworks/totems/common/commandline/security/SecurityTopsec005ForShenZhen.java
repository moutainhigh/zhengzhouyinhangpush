...
public class SecurityTopsec005ForShenZhen extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityTopsec005ForShenZhen.class);
    ...
    public String createCommandLine(CommandlineDTO dto) {
        ...
        sb.append(String.format("policy add action %s log on slog on %s%s" +
    ...
    public static void main(String[] args) {
        ...
        SecurityTopsec005ForShenZhen topsec = new SecurityTopsec005ForShenZhen();
