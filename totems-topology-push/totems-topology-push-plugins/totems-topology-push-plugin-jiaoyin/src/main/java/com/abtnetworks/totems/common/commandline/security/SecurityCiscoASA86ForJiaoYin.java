...
public class SecurityCiscoASA86ForJiaoYin extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = LoggerFactory.getLogger(SecurityCiscoASA86ForJiaoYin.class);
    ...
    public String generateCommandline(CommandlineDTO dto) {
        ...
        PolicyObjectDTO dstAddress = generateAddressObject(dto.getDstIp(), ticket, createObjFlag, specialObject.getDstAddressObjectName(), dto.getDstIpSystem());
    ...
    public String generateCommandline(CommandlineDTO dto,Integer mergeProperty) {
        ...
        String commandLine = securityCiscoASAForJiaoYin.commonLine(srcAddress, dstAddress, serviceObject, dto,mergeProperty);
    ...
    public PolicyObjectDTO generateAddressObject(String ipAddress, String ticket, boolean createObjFlag,
        ...
        if (createObjFlag && StringUtils.isNotBlank(ipSystem)) {
            String objName = String.format("%s", ipSystem);
            //只有一个，直接创建对象，引用即可
            if (arr.length == 1) {
