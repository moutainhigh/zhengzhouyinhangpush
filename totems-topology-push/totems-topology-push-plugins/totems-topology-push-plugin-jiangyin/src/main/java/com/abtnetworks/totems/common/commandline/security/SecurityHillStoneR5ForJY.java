...
public class SecurityHillStoneR5ForJY extends SecurityPolicyGenerator implements PolicyGenerator {
    ...
    public SecurityHillStoneR5ForJY() {
        init();
    }
...
//        sb.append(String.format("name %s\n", dto.getBusinessName()));
        if(!AliStringUtils.isEmpty(dto.getBusinessName())){
    ...
    public static void main(String[] args) {
        ...
        dto.setVsys(true);
        dto.setVsysName("zy");
        SecurityHillStoneR5ForJY hillStoneR5 = new SecurityHillStoneR5ForJY();
