...
public class SecurityCiscoASAForJY extends SecurityPolicyGenerator implements PolicyGenerator {
    ...
    public static void main(String[] args) {
        SecurityCiscoASAForJY ciscoASA = new SecurityCiscoASAForJY();
