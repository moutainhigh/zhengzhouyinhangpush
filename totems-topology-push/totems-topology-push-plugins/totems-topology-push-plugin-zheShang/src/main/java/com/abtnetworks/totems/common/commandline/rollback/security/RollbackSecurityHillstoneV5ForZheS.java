 ...
 */
@Slf4j
@CustomCli(value = DeviceModelNumberEnum.HILLSTONE_V5, type = PolicyEnum.SECURITY, classPoxy = RollbackSecurityHillstoneR5.class)
@Service
public class RollbackSecurityHillstoneV5ForZheS implements PolicyGenerator {
