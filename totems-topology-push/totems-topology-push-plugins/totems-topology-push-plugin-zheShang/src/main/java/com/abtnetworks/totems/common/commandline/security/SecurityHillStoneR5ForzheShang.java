...
public class SecurityHillStoneR5ForzheShang extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityHillStoneR5ForzheShang.class);
    ...
    public SecurityHillStoneR5ForzheShang() {
        init();
    }
...
//        }
    ...
    public PolicyObjectDTO generateAddressObjectForNat(String ipAddress, String ticket, String ipPrefix, boolean createObjFlag, String existsAddressName,String ipSystem) {
        ...
        if(arr.length>1){
            ...
            if(arr.length == 1){
                //直接显示内容
                formatFullAddress(arr[0], sb, ipPrefix, false, dto, name, arr.length, 0);
                dto.setCommandLine(sb.toString());
                dto.setName(sb.toString());
            }
    ...
    public static void main(String[] args) {
        ...
        dto.setVsys(true);
        dto.setVsysName("zy");
        SecurityHillStoneR5ForzheShang hillStoneR5 = new SecurityHillStoneR5ForzheShang();
