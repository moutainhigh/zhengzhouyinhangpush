...
public class SecurityCiscoASA99ForzheShang extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = LoggerFactory.getLogger(SecurityCiscoASA99ForzheShang.class);
    ...
    public String generateCommandline(CommandlineDTO dto) {
        ...
        SecurityCiscoASA99ForzheShang securityCiscoASA = new SecurityCiscoASA99ForzheShang();
...
//            dto.setObjectFlag(false);
    ...
    public String commonLine(PolicyObjectDTO srcAddress, PolicyObjectDTO dstAddress, PolicyObjectDTO serviceObject,
        ...
        if (createObjFlag || (serviceObject.isObjectFlag() && srcAddress.isObjectFlag() && dstAddress.isObjectFlag())) {
            ...
            sb.append(String.format("access-list %s%s extended %s %s", businessName, StringUtils.isBlank(line1) ? line1 : " " + line1, dto.getAction().toLowerCase(), objectString));
            if (time != null) {
...
@Override
    ...
    public static void main(String[] args) {
        ...
        SecurityCiscoASA99ForzheShang cisco = new SecurityCiscoASA99ForzheShang();

        dto.setSrcIp("1.1.1.1,1.2.3.4/24,3.4.5.6-3.4.5.60");
        dto.setDstIp("1.1.1.1,1.2.3.4/24,3.4.5.6-3.4.5.60");
...
//        service.setProtocol("6");
        service1.setDstPorts("22.55");
        ServiceDTO service2 = new ServiceDTO();
        service2.setProtocol("17");
        service2.setDstPorts("12.56");
