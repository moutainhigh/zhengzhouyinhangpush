...
public class SecurityHillStoneR5ForShanShi extends SecurityPolicyGenerator implements PolicyGenerator {

    private static final Logger logger = Logger.getLogger(SecurityHillStoneR5ForShanShi.class);
    ...
    public SecurityHillStoneR5ForShanShi() {
        init();
    }
    ...
    public static void main(String[] args) {
        ...
        SecurityHillStoneR5ForShanShi hillStoneR5 = new SecurityHillStoneR5ForShanShi();
