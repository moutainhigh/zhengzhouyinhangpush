...
public class SecurityTopsecNG2ForGuangZhouNX extends SecurityPolicyGenerator implements PolicyGenerator {
    public final int MAX_OBJECT_NAME_LENGTH = 30;
    private static Logger logger = Logger.getLogger(SecurityTopsecNG2ForGuangZhouNX.class);
...
//        ipv4
    ...
    public static void main(String[] args) {
        ...
        SecurityTopsecNG2ForGuangZhouNX topsec = new SecurityTopsecNG2ForGuangZhouNX();
        ...
        serviceDTO.setDstPorts("22,89-90");
        dto.setServiceList(serviceDTOS);
        serviceDTOS.add(serviceDTO);
        dto.setRestServiceList(serviceDTOS);
       /* dto.setSrcIp("1.1.1.1/23,5.5.5.5");
        dto.setDstIp("2.2.2.2-4.4.4.4");*/
        dto.setSrcIp("a001:3002::4003/4009,c008:5009::6001");
        dto.setDstIp("a001:3002::4003-c001:3002::4005");
