 ...
 * @Desc:天融信 Topsec TOS 005
 */

@Service
@CustomCli(value = DeviceModelNumberEnum.TOPSEC_TOS_005, type = PolicyEnum.SECURITY)
public class SecurityTopsecForGuangZhouNX extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityTopsecForGuangZhouNX.class);
...
//        ipv4
    ...
    public static void main(String[] args) {
        ...
        SecurityTopsecForGuangZhouNX topsec = new SecurityTopsecForGuangZhouNX();
        ...
        serviceDTO.setDstPorts("22-80,89-90");
        serviceDTO.setDstPorts("33");
        dto.setServiceList(serviceDTOS);
        serviceDTOS.add(serviceDTO);
        dto.setRestServiceList(serviceDTOS);
        /*dto.setSrcIp("1.1.1.1-2.2.2.2");
        dto.setDstIp("2.2.2.2/23");*/
        dto.setSrcIp("b008:3009::6003/127,c001:3002::4005");
        dto.setDstIp("c008:3002::4005-b004:3009::6003");
        dto.setSrcIpSystem("");
        dto.setDstIpSystem("");
