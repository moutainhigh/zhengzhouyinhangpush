...
public class SecurityUsg6000ForGuangZhou extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityUsg6000ForGuangZhou.class);
...
//                    }
    ...
    public static void main(String[] args) {
        SecurityUsg6000ForGuangZhou usg6000 = new SecurityUsg6000ForGuangZhou();
