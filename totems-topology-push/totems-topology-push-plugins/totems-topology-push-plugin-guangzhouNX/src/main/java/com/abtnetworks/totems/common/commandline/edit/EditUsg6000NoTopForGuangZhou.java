...
import com.abtnetworks.totems.common.commandline.security.SecurityUsg6000NoTopForGuangZhou;
 ...
 */
@Service
@CustomCli(value = DeviceModelNumberEnum.USG6000_NO_TOP, type = PolicyEnum.EDIT_SECURITY)
public class EditUsg6000NoTopForGuangZhou extends EditPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(EditUsg6000NoTopForGuangZhou.class);
    ...
    public String createCommandLine(EditCommandlineDTO dto){
        SecurityUsg6000NoTopForGuangZhou securityUsg6000 = new SecurityUsg6000NoTopForGuangZhou();
