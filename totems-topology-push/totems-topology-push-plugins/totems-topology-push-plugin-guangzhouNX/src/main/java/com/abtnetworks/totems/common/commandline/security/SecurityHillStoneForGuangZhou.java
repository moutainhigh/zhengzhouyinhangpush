...
public class SecurityHillStoneForGuangZhou extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityHillStoneForGuangZhou.class);
    ...
    public SecurityHillStoneForGuangZhou() {
        init();
    }
    ...
    public PolicyObjectDTO generateServiceObject(List<ServiceDTO> serviceDTOList, List<String> existServiceNameList, Integer idleTimeout, Integer ipType) {
        ...
        for(ServiceDTO service : serviceDTOList){
            ...
            if(idleTimeout != null) {
                name = String.format("\"%s_%sL\"", protocolString, service.getDstPorts());
            }
            if(PortUtils.isPortRange(service.getDstPorts())) {
                ...
                if(idleTimeout != null) {
                    name =  String.format("\"%s_%s-%sL\"", protocolString, start, end);
                }
            }
    ...
    public static void main(String[] args) {
        ...
        SecurityHillStoneForGuangZhou hillStoneR5 = new SecurityHillStoneForGuangZhou();
        ...
        dto.setSrcIp("127.0.0.1");
        dto.setDstIp("1.1.1.1");
        dto.setSrcIpSystem("");
        dto.setDstIpSystem("");
