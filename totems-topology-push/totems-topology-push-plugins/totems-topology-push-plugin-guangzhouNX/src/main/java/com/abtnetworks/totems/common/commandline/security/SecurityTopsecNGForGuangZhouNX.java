...
public class SecurityTopsecNGForGuangZhouNX extends SecurityPolicyGenerator implements PolicyGenerator {
    public final int MAX_OBJECT_NAME_LENGTH = 30;
    private static Logger logger = Logger.getLogger(SecurityTopsecNGForGuangZhouNX.class);
...
//        ipv4
    ...
    public static void main(String[] args) {
        ...
        SecurityTopsecNGForGuangZhouNX topsec = new SecurityTopsecNGForGuangZhouNX();
