 ...
 */
@Service
@CustomCli(value = DeviceModelNumberEnum.HILLSTONE_R5, type = PolicyEnum.EDIT_SECURITY)
public class EditHillStoneForGuangZhou extends EditPolicyGenerator implements PolicyGenerator {
