...
public class SecurityUsg6000NoTopForGuangZhou extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityUsg6000NoTopForGuangZhou.class);
...
//                    }
    ...
    private PolicyObjectDTO generateTimeObject(String startTimeString, String endTimeString, String ticket) {
        ...
        String objName=finstartTime+"_"+finendTime;
        PolicyObjectDTO dto = new PolicyObjectDTO();
        dto.setName(objName);
    ...
    public static void main(String[] args) {
        ...
        SecurityUsg6000NoTopForGuangZhou juniperSrx = new SecurityUsg6000NoTopForGuangZhou();
