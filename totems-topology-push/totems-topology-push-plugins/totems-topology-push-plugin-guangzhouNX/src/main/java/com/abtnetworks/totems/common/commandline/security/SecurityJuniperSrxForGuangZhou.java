...
public class SecurityJuniperSrxForGuangZhou extends SecurityPolicyGenerator implements PolicyGenerator {
    ...
    private PolicyObjectDTO generateAddressObject(String ipAddress, String zone, String ticket, String existsAddressName, String ipSystem) {
        ...
        dto.setName(sbName.toString().replace(",", " "));
    ...
    public static void main(String[] args) {
        ...
        SecurityJuniperSrxForGuangZhou juniperSrx = new SecurityJuniperSrxForGuangZhou();
        List<ServiceDTO> srcport=new ArrayList<>();
        ServiceDTO serviceDTO = new ServiceDTO();
        serviceDTO.setProtocol("6");
        serviceDTO.setSrcPorts("22,55-66");
        serviceDTO.setDstPorts("70-90,80");

        srcport.add(serviceDTO);
        dto.setSrcIp("1.1.1.1/32");
        dto.setDstIp("127.0.0.1-2.2.2.2");
        dto.setSrcIpSystem("");
        dto.setDstIpSystem("");
...
//
       /* dto.setSrcIp("1111:a1a1::1111/4008");
