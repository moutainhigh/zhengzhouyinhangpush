...
public class SecurityCiscoASAForZXTX extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = LoggerFactory.getLogger(SecurityCiscoASAForZXTX.class);
    ...
    public static void main(String[] args) {
        SecurityCiscoASAForZXTX ciscoASA = new SecurityCiscoASAForZXTX();
...
//        restDst.add("11.12.12.3/32");
        restDst.add("11.12.12.3-11.12.12.4");
