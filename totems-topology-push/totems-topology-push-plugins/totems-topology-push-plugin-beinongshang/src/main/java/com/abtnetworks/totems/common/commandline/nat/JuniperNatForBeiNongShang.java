...
@Slf4j
@Service
public class JuniperNatForBeiNongShang implements NatPolicyGenerator {
    ...
    public String generateSNatCommandLine(SNatPolicyDTO policyDTO) {
        ...
        natName = StringUtils.isEmpty(policyDTO.getDescription()) ? natName : descripTionCode(policyDTO.getDescription());
...
//        JuniperNatForBeiNongShang juniperNat = new JuniperNatForBeiNongShang();
//
////        String a="{" +
////                "    \"existDstAddressList\": []," +
////                "    \"description\": \"suguanduo@qq.com\"," +
////                "    \"createObjFlag\": false," +
////                "    \"existSrcAddressName\": []," +
////                "    \"restSrcAddressList\": [" +
////                "        \"1.1.1.1-1.1.1.2\"" +
