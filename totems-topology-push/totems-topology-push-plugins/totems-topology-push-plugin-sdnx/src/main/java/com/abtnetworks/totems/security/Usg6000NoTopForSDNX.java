...
public class Usg6000NoTopForSDNX extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(Usg6000NoTopForSDNX.class);
    ...
    private String createCommandLine(CommandlineDTO dto) {
        ...
        if (dto.getIdleTimeout() != null) {
            ...
            sb.append("long-link aging-time 24\n");
        }
...
//                    }
    ...
    public static void main(String[] args) {
        Usg6000NoTopForSDNX usg6000 = new Usg6000NoTopForSDNX();
