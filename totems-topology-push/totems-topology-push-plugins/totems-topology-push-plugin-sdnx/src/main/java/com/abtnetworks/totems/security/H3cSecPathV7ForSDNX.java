...
public class H3cSecPathV7ForSDNX extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(H3cSecPathV7ForSDNX.class);
    ...
    public static void main(String[] args) {
        ...
        H3cSecPathV7ForSDNX h3cv7 = new H3cSecPathV7ForSDNX();
