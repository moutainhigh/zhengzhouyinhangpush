...
public class JuniperSrxForSDNX extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = LoggerFactory.getLogger(JuniperSrxForSDNX.class);
    ...
    public String createCommandLine(CommandlineDTO dto) {
        ...
        PolicyObjectDTO service = generateServiceObject(dto.getServiceList(), createObjFlag, dto.getServiceName(),dto);
     ...
     * @return 服务对象
     */
    private PolicyObjectDTO generateServiceObject(List<ServiceDTO> serviceDTOList,  boolean createObjFlag, String existsServiceName, CommandlineDTO cmdDto) {
        PolicyObjectDTO dto = new PolicyObjectDTO();
    ...
    public static void main(String[] args) {
        ...
        JuniperSrxForSDNX juniperSrx = new JuniperSrxForSDNX();
