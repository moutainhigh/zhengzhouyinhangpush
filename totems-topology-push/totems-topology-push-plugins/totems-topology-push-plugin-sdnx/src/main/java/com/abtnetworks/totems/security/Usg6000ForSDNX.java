...
public class Usg6000ForSDNX extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(Usg6000ForSDNX.class);
...
//                    }
    ...
    public static void main(String[] args) {
        Usg6000ForSDNX usg6000 = new Usg6000ForSDNX();
