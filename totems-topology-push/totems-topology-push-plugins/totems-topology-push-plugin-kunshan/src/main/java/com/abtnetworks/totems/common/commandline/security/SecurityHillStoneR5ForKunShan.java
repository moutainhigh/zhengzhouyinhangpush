...
public class SecurityHillStoneR5ForKunShan extends SecurityPolicyGenerator implements PolicyGenerator {

    private static final Logger logger = Logger.getLogger(SecurityHillStoneR5ForKunShan.class);
    ...
    public SecurityHillStoneR5ForKunShan() {
        init();
    }
    ...
    public static void main(String[] args) {
        ...
        serviceDTO.setDstPorts("6817-60");
        ...
        SecurityHillStoneR5ForKunShan hillStoneR5 = new SecurityHillStoneR5ForKunShan();
