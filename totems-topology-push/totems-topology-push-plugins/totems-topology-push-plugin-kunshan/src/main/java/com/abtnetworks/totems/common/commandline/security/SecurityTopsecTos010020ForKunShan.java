...
public class SecurityTopsecTos010020ForKunShan extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityTopsecTos010020ForKunShan.class);
    ...
    public PolicyObjectDTO generateAddressObject(String ipAddress, String ticket, String existsAddressName, String ipSystem, Integer ipType) {
        ...
        for (String address : arr) {
            ...
            if (StringUtils.isBlank(name)) {
                ...
                } else if (address != null && IpUtils.isIPRange(address)) {
                    name = "N_" + address;
                } else {
                    name = "H_" + address;
                }
...
//        dto.setEndTime("2008-1-3 10:33:16");
        ...
        ServiceDTO serviceDTO = new ServiceDTO();
        serviceDTO.setProtocol("6");
        serviceDTO.setDstPorts("20-25,78");
        dto.setServiceList(serviceDTOS);
        serviceDTOS.add(serviceDTO);
        dto.setRestServiceList(serviceDTOS);
        dto.setSrcIp("2.4.3.1-10.32.4.2,1.1.1.1/24");
        dto.setDstIp("4.6.2.6");
        String commandLine = topsec.composite(dto);
        System.out.println("commandline:\n" + commandLine);
