...
public class SecurityCiscoASA99ForKunShan extends SecurityPolicyGenerator implements PolicyGenerator {
...
//            objName = ipSystem;
        ...
        if (createObjFlag) {
            ...
            if (arr.length == 1) {
                ...
                sb.append(getAddressObject(arr[0], objName, null,ipType,ipSystem));
            ...
            //直接显示内容
            for (String ip : arr) {
                getAddressObject(ip, "", list,ipType,ipSystem);
            }
    ...
    private String getAddress(String ipAddress) {
        ...
        if(ipAddress.contains("/")){
            name = "subnet "+ipAddress;
        }else if(ipAddress.contains("-")){
            name = "range "+ipAddress.replace("-"," ");
        }else {
            name = "host "+ipAddress;
        }
        return name;
    ...
    public String getAddressObject(String ipAddress, String name, List<String> list, Integer ipType,String ipSystem) {
        StringBuilder sb = new StringBuilder();
        //昆山农商定制需求
        ...
        /*if (!AliStringUtils.isEmpty(ipSystem)) {
            sb.append(String.format("object network %s_%s \n", name));
        }else */
        ...
        if (IpUtils.isIPRange(ipAddress)) {
            ...
            if(ipAddress.contains(":")){
                // TODO ipv6类型
                //昆山农商定制需求
                String addressName = getAddress(ipAddress);
                fullStr = String.format("%s", addressName);
    ...
    public static void main(String[] args) {
        ...
        SecurityCiscoASA99ForKunShan cisco = new SecurityCiscoASA99ForKunShan();
        List<String> restSrc = new ArrayList<>();
        restSrc.add("a001:111::1111-a001:111::1113");
...
//        restDst.add("12.12.12.3/24");
        ...
        serviceDTO.setDstPorts("7899-8000");
