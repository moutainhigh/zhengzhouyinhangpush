...
public class SecurityTopsecNGForHuaRui extends SecurityPolicyGenerator implements PolicyGenerator {
    public final int MAX_OBJECT_NAME_LENGTH = 30;
    private static Logger logger = Logger.getLogger(SecurityTopsecNGForHuaRui.class);
...
//        ipv4
    ...
    public static void main(String[] args) {
        ...
        SecurityTopsecNGForHuaRui topsec = new SecurityTopsecNGForHuaRui();


        List<ServiceDTO> serviceDTOS = new ArrayList<>();
        ServiceDTO serviceDTO = new ServiceDTO();
        serviceDTO.setProtocol("6");
        serviceDTO.setDstPorts("90-99,8080");
