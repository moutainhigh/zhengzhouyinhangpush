...
public class SecurityHillStoneForHuaRui extends SecurityPolicyGenerator implements PolicyGenerator {

    private static final Logger logger = Logger.getLogger(SecurityHillStoneForHuaRui.class);
    ...
    public SecurityHillStoneForHuaRui() {
        init();
    }
    ...
    public static void main(String[] args) {
        ...
        SecurityHillStoneForHuaRui hillStoneR5 = new SecurityHillStoneForHuaRui();
