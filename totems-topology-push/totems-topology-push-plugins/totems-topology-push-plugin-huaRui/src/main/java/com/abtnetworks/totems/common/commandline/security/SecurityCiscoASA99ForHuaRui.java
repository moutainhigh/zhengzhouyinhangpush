...
public class SecurityCiscoASA99ForHuaRui extends SecurityPolicyGenerator implements PolicyGenerator {
    ...
    public static void main(String[] args) {
        ...
        serviceDTO.setSrcPorts("23-56,44");
        serviceDTO.setDstPorts("22-90");
        srcport.add(serviceDTO);

        dto.setServiceList(srcport);

        dto.setSrcIp("127.0.0.1/10,5.5.5.5");
        dto.setDstIp("1.1.1.1-6.6.6.6,3.3.3.3");
        dto.setSrcIpSystem("");
        dto.setDstIpSystem("");
        ...
        SecurityCiscoASA99ForHuaRui hillStoneR5 = new SecurityCiscoASA99ForHuaRui();
