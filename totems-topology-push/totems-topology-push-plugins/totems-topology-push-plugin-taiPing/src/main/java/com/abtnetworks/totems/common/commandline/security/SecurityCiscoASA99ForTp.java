...
public class SecurityCiscoASA99ForTp extends SecurityPolicyGenerator implements PolicyGenerator {
    ...
    public String generate(CmdDTO cmdDTO) {
        ...
        log.info("思科 ASA 9.9 dto is" + JSONObject.toJSONString(dto, true));
...
//                        String refObjName = String.format("%s_AG_%s", ticket, IdGen.getRandomNumberString());
    ...
    public String commonLine(PolicyObjectDTO srcAddress, PolicyObjectDTO dstAddress, PolicyObjectDTO serviceObject,
        ...
        if(!AliStringUtils.isEmpty(description) && StringUtils.isBlank(line1)){
