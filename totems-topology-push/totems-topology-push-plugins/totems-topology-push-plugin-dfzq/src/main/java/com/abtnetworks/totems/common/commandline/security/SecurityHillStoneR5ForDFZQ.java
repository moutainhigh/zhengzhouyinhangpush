...
public class SecurityHillStoneR5ForDFZQ extends SecurityPolicyGenerator implements PolicyGenerator {

    private static Logger logger = Logger.getLogger(SecurityHillStoneR5ForDFZQ.class);
    ...
    public SecurityHillStoneR5ForDFZQ() {
        init();
    }
    ...
    public static void main(String[] args) {
        ...
        SecurityHillStoneR5ForDFZQ hillStoneR5 = new SecurityHillStoneR5ForDFZQ();
