...
public class SecurityFortinetFortiOSForDFZQ extends SecurityPolicyGenerator implements PolicyGenerator {
    private static Logger logger = Logger.getLogger(SecurityFortinetFortiOSForDFZQ.class);
