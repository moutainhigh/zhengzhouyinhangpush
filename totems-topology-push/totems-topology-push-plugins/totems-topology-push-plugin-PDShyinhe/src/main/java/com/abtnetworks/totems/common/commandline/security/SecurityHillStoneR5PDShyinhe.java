...
public class SecurityHillStoneR5PDShyinhe extends SecurityPolicyGenerator implements PolicyGenerator {
    ...
    public SecurityHillStoneR5PDShyinhe() {
        init();
    }
    ...
    private void formatFullAddress(String address, StringBuilder sb, String ipPrefix, boolean createObjFlag, PolicyObjectDTO dto, String ticket, String ipSystem, int length,
        ...
        name = LineNameUtils.getIPNameKevin(ipType,address,true,ipSystem,ipSystem,length,index);
...
//                }
//            }
            String name = LineNameUtils.getServiceNameKevin(serviceKey, protocolString,service.getDstPorts(),idleTimeout);
    ...
    public static void main(String[] args) {
        ...
        SecurityHillStoneR5PDShyinhe hillStoneR5 = new SecurityHillStoneR5PDShyinhe();
