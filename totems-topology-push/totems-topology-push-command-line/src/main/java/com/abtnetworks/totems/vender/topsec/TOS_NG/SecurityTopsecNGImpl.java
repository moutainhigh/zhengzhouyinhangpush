package com.abtnetworks.totems.vender.topsec.TOS_NG;
 ...
 * @Description:
 */
public class SecurityTopsecNGImpl extends OverAllGeneratorAbstractBean {
    ...
    public String generateIpAddressObjectGroupCommandLine(StatusTypeEnum statusTypeEnum, RuleIPTypeEnum ipTypeEnum,
        ...
        ipAddressGroupCl.append(" group-address add name " + name + " member '");
        // 本次生成的地址对象
