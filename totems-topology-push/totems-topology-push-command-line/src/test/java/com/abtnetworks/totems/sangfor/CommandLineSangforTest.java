package com.abtnetworks.totems.sangfor;
...
//        paramDTO.setAbsoluteTimeParamDTO(absoluteTimeParamDTO);
        ...
        SecuritySangforImpl securitySangfor = new SecuritySangforImpl();
        System.out.println("深信服命令行------------------》");
        System.out.println(securitySangfor.generateSecurityPolicyCommandLine(null,paramDTO,null,null));
    }
