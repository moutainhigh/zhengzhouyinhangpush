package com.abtnetworks.totems.h3c;
...
//        paramDTO.setAbsoluteTimeParamDTO(absoluteTimeParamDTO);
        ...
        SecurityH3cSecPathV5Impl securityH3cSecPathV5 = new SecurityH3cSecPathV5Impl();
        System.out.println("华三V5命令行------------------》");
        System.out.println(securityH3cSecPathV5.generateSecurityPolicyCommandLine(null,paramDTO,null,null));
    }

    @Test
    public void testH3cV7CommandLine() throws Exception {
        PolicyParamDTO paramDTO = new PolicyParamDTO();
        paramDTO.setAction("permit");
        paramDTO.setDescription("华三V7命令行生成");
        paramDTO.setSrcZone(new ZoneParamDTO("trust"));
        paramDTO.setDstZone(new ZoneParamDTO("untrust"));
        paramDTO.setId("666");
        paramDTO.setName("newH3v5Policy");
...
//        paramDTO.setAbsoluteTimeParamDTO(absoluteTimeParamDTO);
        ...
        SecurityH3cSecPathV7Impl securityH3cSecPathV7 = new SecurityH3cSecPathV7Impl();
        System.out.println("华三命令行------------------》");
        System.out.println(securityH3cSecPathV7.generateSecurityPolicyCommandLine(null,paramDTO,null,null));
    }
}
