 ...
 * @Date: 2021/6/11
 */
public class CommandLineCiscoASATest {

    @Test
    public void testCiscoASACommandLine() throws Exception {
        PolicyParamDTO paramDTO = new PolicyParamDTO();
        paramDTO.setAction("permit");
        paramDTO.setDescription("思科ASA命令行生成");
...
//        paramDTO.setAbsoluteTimeParamDTO(absoluteTimeParamDTO);
        ...
        SecurityCiscoASAImpl securityCiscoASAImpl = new SecurityCiscoASAImpl();
        System.out.println("思科ASA命令行------------------》");
        System.out.println(securityCiscoASAImpl.generateSecurityPolicyCommandLine(StatusTypeEnum.ADD,paramDTO,null,null));
    }
}
