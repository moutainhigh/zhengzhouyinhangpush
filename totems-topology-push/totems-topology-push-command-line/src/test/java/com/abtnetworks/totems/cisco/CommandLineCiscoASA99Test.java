package com.abtnetworks.totems.cisco;
 ...
 * @Date: 2021/6/11
 */
public class CommandLineCiscoASA99Test {

    @Test
    public void testCiscoASA99CommandLine() throws Exception {
        PolicyParamDTO paramDTO = new PolicyParamDTO();
        paramDTO.setAction("permit");
        paramDTO.setDescription("思科ASA99命令行生成");
...
//        paramDTO.setAbsoluteTimeParamDTO(absoluteTimeParamDTO);
        ...
        SecurityCiscoASA99Impl securityCiscoASA99Impl = new SecurityCiscoASA99Impl();
        System.out.println("思科ASA99命令行------------------》");
        System.out.println(securityCiscoASA99Impl.generateSecurityPolicyCommandLine(StatusTypeEnum.ADD,paramDTO,null,null));
    }
}
