package com.abtnetworks.totems.topsec;
...
public class CommandLineTopSecTest {
    ...
    public void testHillstoneCommandLine() throws Exception {
        ...
        ipAddressRangeDTO1.setEnd("192.169.1.24");
        ...
        ipAddressRangeDTO2.setEnd("192.169.12.56");
        ...
        srcIp.setSingleIpArray(new String[]{"192.168.1.1", "192.168.1.2", "192.168.1.3", "192.168.1.4"});
        ...
        SecurityTopsec005Impl securityTopsec = new SecurityTopsec005Impl();
        System.out.println("天融信命令行------------------》");
        System.out.println(securityTopsec.generateSecurityPolicyCommandLine(StatusTypeEnum.ADD,paramDTO,null,null));
    }
