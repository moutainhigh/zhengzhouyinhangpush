...
/**
 * SSH工具类
 * 补充一个，当时测试定位使用的，一般还是走现在的下发流程
 */
public class PaloAltoExec implements Executor {
    private static Logger logger = Logger.getLogger(PaloAltoExec.class);

    private final Integer BUF_LEN = 1024 * 8;

    private final String MODLE_NUMBER = "Palo Alto Firewall";
