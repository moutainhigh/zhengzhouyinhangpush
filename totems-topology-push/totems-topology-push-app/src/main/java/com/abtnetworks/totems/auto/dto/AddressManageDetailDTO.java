...
@Data
@ApiModel("对象管理详情表")
public class AddressManageDetailDTO {
    ...
    private List<AddressManageDetailDTO> child;

    @ApiModelProperty(value = "地址对象条目")
    private List<AddressDetailEntryEntity> addressDetailEntryList;
