 ...
 */
public class ImportPolicyScenesOrderDTO extends ImportOrderDTO {
    ...
    @Override
    @ExcelField(title="源地址",type = 2,align=2, sort=40)
    public String getSrcIp() {
        return srcIp;
    }

    @Override
    @ExcelField(title="目的地址",type = 2,align=2, sort=50)
    ...
    @Override
    @ExcelField(title="动作",type = 2,align=2, sort=70)
    public String getAction() {
        return action;
    }

    @Override
    @ExcelField(title="备注",type = 2,align=2, sort=80)
