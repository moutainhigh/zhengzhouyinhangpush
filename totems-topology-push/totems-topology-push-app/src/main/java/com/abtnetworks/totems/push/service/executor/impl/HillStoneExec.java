 ...
 *
 */
public class HillStoneExec implements Executor {
    private static Logger logger = Logger.getLogger(HillStoneExec.class);

    private final Integer BUF_LEN = 1024 * 8;

    private final String MODLE_NUMBER = "HillStone";
