 ...
 * @Author hw
 * @Description
 * @Date 14:07 2019/11/26
 */
public class DisposalCreateCommandLineRecordEntity extends BaseEntity {

    private static final long serialVersionUID = 8972804342044038473L;
