 ...
 */
public class ImportRoutingEvilIpOrderDTO extends ImportOrderDTO {
    ...
    @Override
    @ExcelField(title="黑洞路由IP",type = 2,align=2, sort=30)
    public String getRoutingIp() {
        return routingIp;
    }

    @Override
    @ExcelField(title="动作",type = 2,align=2, sort=40)
    public String getAction() {
        return action;
    }

    @Override
    @ExcelField(title="备注",type = 2,align=2, sort=50)
